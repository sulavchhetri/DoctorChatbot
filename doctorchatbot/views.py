...
sym = pd.read_csv(r"C:\Users\Acer\OneDrive - Tribhuvan University\Desktop\chatbotfinal\dataset\Symptom-severity.csv")
sym['Symptom'] = sym['Symptom'].str.replace('_',' ')
desc = pd.read_csv(r'C:\Users\Acer\OneDrive - Tribhuvan University\Desktop\chatbotfinal\dataset\symptom_description.csv')
prev = pd.read_csv(r'C:\Users\Acer\OneDrive - Tribhuvan University\Desktop\chatbotfinal\dataset\symptom_precaution.csv')
